...
The best way to learn how-to then use these technologies to create in Decentraland is **Carl Fravel's Decentraland University VR Academy course "Building in Decentraland"**. The course took place Aug-Sep 2019 and its lessons plus course materials can be found on the [Decentraland University Youtube channel](https://www.youtube.com/playlist?list=PLrON4JHIuqpkNeeUCMOnDCdZ53S6o3Ndw). [Carl](https://github.com/cfravel) is founder of the Decentraland University.  

The course is a well-paced walk through the Decentraland technologies, useful building tools, the SDK and how-to program it up-to how-to work with 3D modelling software like Blender peppered with loads of tips and tricks. You may want to join the [Decentraland Univerity Discord](https://discord.gg/UK6AZCd) for further inquiries.   
